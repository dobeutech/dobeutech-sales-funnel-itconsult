...
// Temporary export to prevent breaking downstream components that import sql until they are refactored
export const sql = () => { throw new Error('Direct database queries are deprecated. Use API endpoints instead.') };
